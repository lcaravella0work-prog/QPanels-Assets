...
class SetActiveCollection(Operator):
    ...
    bl_idname = "qpanel_outliner.set_active_collection"
    bl_options = {'UNDO'}
    ...
    def execute(self, context):
        if self.is_master_collection:
            ...
            qpo.qpo_list_index = laycol["row_index"]
...
class ExpandAllOperator(Operator):
    ...
    bl_idname = "qpanel_outliner.expand_all_items"

    def execute(self, context):
        if len(internals.expanded) > 0:
            internals.expanded.clear()
            context.scene.qpanel_outliner.qpo_list_index = 0
        else:
...
class ExpandSublevelOperator(Operator):
    ...
    bl_idname = "qpanel_outliner.expand_sublevel"
    ...
    def invoke(self, context, event):
        ...
        context.scene.qpanel_outliner.qpo_list_index = self.index
...
class QPOutlinerSelectCollectionObjectsOperator(Operator):
    ...
    bl_idname = "qpanel_outliner.select_collection_objects"
...
class SelectAllCumulativeObjectsOperator(Operator):
    ...
    bl_idname = "qpanel_outliner.select_all_cumulative_objects"
...
class QPOutlinerExcludeOperator(Operator):
    ...
    bl_idname = "qpanel_outliner.exclude_collection"
    bl_options = {'REGISTER', 'UNDO'}
...
class QPOutlinerUnExcludeAllOperator(Operator):
    ...
    bl_idname = "qpanel_outliner.un_exclude_all_collections"
    bl_options = {'REGISTER', 'UNDO'}
...
class QPOutlinerRestrictSelectOperator(Operator):
    ...
    bl_idname = "qpanel_outliner.restrict_select_collection"
    bl_options = {'REGISTER', 'UNDO'}
    ...
    def invoke(self, context, event):
        cls = QPOutlinerRestrictSelectOperator
...
class QPOutlinerUnRestrictSelectAllOperator(Operator):
    ...
    bl_idname = "qpanel_outliner.un_restrict_select_all_collections"
    bl_options = {'REGISTER', 'UNDO'}
...
class QPOutlinerHideOperator(Operator):
    ...
    bl_idname = "qpanel_outliner.hide_collection"
    bl_options = {'REGISTER', 'UNDO'}
...
class QPOutlinerUnHideAllOperator(Operator):
    ...
    bl_idname = "qpanel_outliner.un_hide_all_collections"
    bl_options = {'REGISTER', 'UNDO'}
...
class QPOutlinerDisableViewportOperator(Operator):
    ...
    bl_idname = "qpanel_outliner.disable_viewport_collection"
    bl_options = {'REGISTER', 'UNDO'}
    ...
    def invoke(self, context, event):
        cls = QPOutlinerDisableViewportOperator
...
class QPOutlinerUnDisableViewportAllOperator(Operator):
    ...
    bl_idname = "qpanel_outliner.un_disable_viewport_all_collections"
    bl_options = {'REGISTER', 'UNDO'}
...
class QPOutlinerDisableRenderOperator(Operator):
    ...
    bl_idname = "qpanel_outliner.disable_render_collection"
    bl_options = {'REGISTER', 'UNDO'}
    ...
    def invoke(self, context, event):
        cls = QPOutlinerDisableRenderOperator
...
class QPOutlinerUnDisableRenderAllOperator(Operator):
    ...
    bl_idname = "qpanel_outliner.un_disable_render_all_collections"
    bl_options = {'REGISTER', 'UNDO'}
...
class QPOutlinerHoldoutOperator(Operator):
    bl_label = "[HH] Holdout"
    bl_description = (
        "  * Shift+LMB - Isolate/Restore.\n"
        "  * Shift+Ctrl+LMB - Isolate nested/Restore.\n"
    ...
    bl_idname = "qpanel_outliner.holdout_collection"
    bl_options = {'REGISTER', 'UNDO'}
...
class QPOutlinerUnHoldoutAllOperator(Operator):
    ...
    bl_idname = "qpanel_outliner.un_holdout_all_collections"
    bl_options = {'REGISTER', 'UNDO'}
...
class QPOutlinerIndirectOnlyOperator(Operator):
    ...
    bl_idname = "qpanel_outliner.indirect_only_collection"
    bl_options = {'REGISTER', 'UNDO'}
    ...
    def invoke(self, context, event):
        cls = QPOutlinerIndirectOnlyOperator
...
class QPOutlinerUnIndirectOnlyAllOperator(Operator):
    ...
    bl_idname = "qpanel_outliner.un_indirect_only_all_collections"
    bl_options = {'REGISTER', 'UNDO'}
...
class QPOutlinerRemoveCollectionOperator(Operator):
    '''Remove Collection'''
    bl_label = "Remove Collection"
    bl_idname = "qpanel_outliner.remove_collection"
    bl_options = {'UNDO'}
...
class QPOutlinerRemoveEmptyCollectionsOperator(Operator):
    bl_label = "Remove Empty Collections"
    bl_idname = "qpanel_outliner.remove_empty_collections"
    bl_options = {'UNDO'}
...
rename = [False]
class QPOutlinerNewCollectionOperator(Operator):
    bl_label = "Add New Collection"
    bl_idname = "qpanel_outliner.add_collection"
    bl_options = {'UNDO'}
    ...
    def execute(self, context):
        ...
        if qpo.qpo_list_index == -1 and ui.QPO_UL_items.filtering:
            send_report("Cannot create new collection.\n"
                        "No collection is selected and collections are filtered."
                       )
            return {'CANCELLED'}

        if qpo.qpo_list_index > -1 and not ui.QPO_UL_items.visible_items[qpo.qpo_list_index]:
            send_report("Cannot create new collection.\n"
        ...
        if len(qpo.qpo_list_collection) > 0:
            if not qpo.qpo_list_index == -1:
                # get selected collection
                laycol = internals.layer_collections[qpo.qpo_list_collection[qpo.qpo_list_index].name]
                ...
                if self.child:
                    ...
                    qpo.qpo_list_index = internals.layer_collections[new_collection.name]["row_index"]
        ...
        ui.QPO_UL_items.new_collections.append(new_collection.name)
...
class QPOutlinerPhantomModeOperator(Operator):
    bl_label = "Toggle Phantom Mode"
    bl_idname = "qpanel_outliner.toggle_phantom_mode"
    bl_description = (
        "Phantom Mode\n"
...
class QPOutlinerApplyPhantomModeOperator(Operator):
    '''Apply changes and quit Phantom Mode'''
    bl_label = "Apply Phantom Mode"
    bl_idname = "qpanel_outliner.apply_phantom_mode"
...
class QPOutlinerUndoWrapper(Operator):
    bl_label = "Undo"
    bl_description = "Undo previous action"
    bl_idname = "qpanel_outliner.undo_wrapper"
    ...
    def execute(self, context):
        ...
        check_state(context, qpo_popup=True)
...
class QPOutlinerRedoWrapper(Operator):
    bl_label = "Redo"
    bl_description = "Redo previous action"
    bl_idname = "qpanel_outliner.redo_wrapper"
